...
# Common Declarations
declare scriptPath=https://github.com/VaishaliRaval/mslearn-aspnet-core/blob/$gitBranch/infrastructure/scripts
...
declare binariesPath=https://github.com/VaishaliRaval/mslearn-aspnet-core/blob/$gitBranch/infrastructure/binaries
declare instanceId=$(($RANDOM * $RANDOM))
declare gitDirectoriesToClone="modules/$moduleName/setup/ modules/$moduleName/src/"
declare gitPathToCloneScript=https://github.com/VaishaliRaval/mslearn-aspnet-core/blob/$gitBranch/infrastructure/scripts/sparsecheckout.sh
if ! [ $rootLocation ]
then
